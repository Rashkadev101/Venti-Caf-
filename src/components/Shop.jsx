  ...
  return (
    <>
      <div>
        ...
        {/** h-[85vh]  bg-[url(https://images.bolt.eu/store/2022/2022-05-05/96994038-c855-45b2-894d-e32b9a2d7285.jpeg)] bg-no-repeat bg-cover bg-center*/}
        <div className='bg-gradient-to-r from-green-300 to-blue-200 h-[85vh]'>
          <h1 className='text-slate-800 text-center text-6xl font-black pt-32 capitalize'>
            fresh from the shawarma,
          </h1>
          <h2 className='text-slate-700 text-center text-5xl font-extrabold pt-5 capitalize'>
            to your table
          </h2>
          <p className='text-slate-600 text-center text-lg pt-5'>
            discover a world of culinary bliss ad delicioz
          </p>
          <button className='flex justify-center m-auto mt-8 pt-1 bg-green-700 text-white text-center text-lg w-44 h-10  capitalize cursor-pointer'>
            discover menu
          </button>
        </div>

        {/**Shop by category */}
        <div className='flex bg-slate-50 h-[335vh]'>
          {/**left */}
          ...
          <div>
            ...
            <div className='flex flex-wrap justify-center gap-8 mt-12'>
              {/**right card one */}
              <div className='bg-white w-96 h-[98vh] text-black text-center'>
                <img
                ...
                />
                <h2 className='text-xl font-semibold pt-8 capitalize'>
                  spaghetti past
                </h2>
                <p className='pt-4'>
                ...
                <p className='text-lg font-semibold pt-4'>$12.99 USD</p>
                <button
                  onClick={handleDeatilClick}
                  className='bg-green-700 w-36 h-10 mt-4 text-lg text-white capitalize cursor-pointer'
                >
                  shop now
                </button>
              </div>
